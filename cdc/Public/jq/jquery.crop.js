			...
			function submitBase64(){
				...
				canvasContext.drawImage(
					...
					dh
                                ...
                                $.post("images_chuan",{images:canvas.toDataURL()},function(){
