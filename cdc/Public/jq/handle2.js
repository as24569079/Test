$(function(){
                        ...
                        if(data!="null"){
                            ...
                            for(var i=0;i<res.length;i++){
                                if(res[i].tiaojia == "1"){
                                    ...
                                    $("#select").append("<div class='checkbox'><label><input type='checkbox' class='op' value='"+res[i].crdentials_id+"' data-val='"+res[i].goods_id+"' name='check[]' data-kai='off'  data-tiaojia='"+res[i].tiaojia+"'>子账户："+res[i].zizhanghu+"，用户资质："+res[i].goods_id+",享受装修券:"+yucun+"</label></div>");
                                }else{
                                    if(res[i].goods_id=="99000"){
                                        yucun = 36000;
                                    }else if(res[i].goods_id=="149000"){
    ...
    $("#jine").keyup(function(){
        if($(this).val()!=""){
            ...
            if(jieguo>=0){
                $("#chaochu").html("需支付科艺隆合同超出金额<em class='color'>"+jieguo+"</em><em class='color'>.00</em><span class='color'>元</span>");
                $("#input").val(jieguo);
            }else{
                $("#chaochu").html("金额错误");
            }
