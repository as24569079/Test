...
$.fn.city = function(){
	...
	//插入3个空的下拉框
	_self.append("<select name='city' class='c-f70' id='city'></select>");
	_self.append("<select name='cityse' class='c-f70' id='cityse'></select>");
	_self.append("<select name='cityser' class='c-f70' id='cityser'></select>");
	//分别获取3个下拉框
