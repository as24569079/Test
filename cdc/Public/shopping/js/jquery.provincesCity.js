...
$.fn.ProvinceCity = function(){
	...
	//插入3个空的下拉框
	_self.append("<select name='yiji' class='city_xiala'></select>");
	_self.append("<select name='erji' class='city_xiala'></select>");
	_self.append("<select name='sanji' class='city_xiala'></select>");
	//分别获取3个下拉框
