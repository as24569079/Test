...
$.fn.city = function(){
	...
	//插入3个空的下拉框
	_self.append("<select name='addyiji' class='c-f70'></select>");
	_self.append("<select name='adderji' class='c-f70'></select>");
	_self.append("<select name='addsanji' class='c-f70'></select>");
	//分别获取3个下拉框
