...
var LR_a4d3b='F7C4849AD36B47378E07AFBB15FDB438';var LR_siteid = '38297030';
var LR_isMobile = 0;
var LR_41d48=LR_a4d3b.replace(/1/g,'3').replace(/0/g,'2');var LR_Tick=new Date().getTime().toString()+parseInt(Math.random()*499999999+Math.random()*400000000+100000000).toString();
var LR_sysurl = 'http://dkt.zoosnet.net/';
LR_41d48=((3+2).toString()+LR_41d48+(3*2).toString());var LR_ALAC=LR_41d48.replace(/5/g,'6').replace(/7/g,'1');if(typeof(LR_cid) == 'undefined')
{
...
var data='id='+LR_siteid+'&sid='+LR_sid+'&cid='+LR_cid+'&lng='+LR_lng;
	data+='&p='+escape(location.href)+'&r='+lr_refer5237+'&e='+escape(LR_explain)+'&NBDA='+LR_ALAC;
