...
var LR_d14b7='420C7B5E156749FDAFBFA224B59F2D69';LR_d14b7=((5+1).toString()+LR_d14b7+(5*1).toString());LR_d14b7=((5+2).toString()+LR_d14b7+(5*2).toString());var LR_siteid = '38297030';
var LR_dc871=LR_d14b7.replace(/1/g,'3').replace(/0/g,'2');var LR_sysurl = 'http://dkt.zoosnet.net/';
var LR_imgurl = 'http://dkt.zoosnet.net/';
var LR_lng = 'cn';
LR_dc871=((5+4).toString()+LR_dc871+(5*4).toString());var LR_ONAN=LR_dc871.replace(/5/g,'6').replace(/7/g,'1');if(typeof(LR_cid) == 'undefined')
{
	...
	var _lr_helpsrc_on=unescape("http%3a%2f%2fdkt.zoosnet.net%2fsite%2f38297030%2fonline_cn.gif");
	...
	var _lr_helpsrc_of=unescape("http%3a%2f%2fdkt.zoosnet.net%2fsite%2f38297030%2fofflineimgsrc_cn.png");
	var _lr_closesrc0='7.gif';
	var _lr_toright=((typeof(LiveReceptionCode_ToRight)!='undefined')?LiveReceptionCode_ToRight:1);
	var _lr_tobottom=((typeof(LiveReceptionCode_ToBottom)!='undefined')?LiveReceptionCode_ToBottom:1);
	var _lr_left=((typeof(LiveReceptionCode_helpimgleft)!='undefined')?LiveReceptionCode_helpimgleft:80);
	var _lr_top=((typeof(LiveReceptionCode_helpimgtop)!='undefined')?LiveReceptionCode_helpimgtop:20);
	var _lr_issupport_track= 1;
	LR_hasInstall=0;
	var LR_ivite_img='http://dkt.zoosnet.net/js/qw_Purple/p.gif';
	var LR_invite_color0='#D48DEB';
	var LR_invite_color1='#F8E1FC';
	var LR_invite_color2='#DAA7E3';
	var LR_invite_color3='#000000';
	var LR_accept_img='js/qw_Purple/a_cn.gif';
	var LR_refuse_img='js/qw_Purple/r_cn.gif';
	var LR_close_img='js/qw_Purple/close.gif';
	...
	var _lr_invite_interval=45;
	var offline_invite_hidden=0;
	if('1'=='1'){LR_showfloat=0;}
	var LR_invite_hide_float=1;
	var LR_above_flash=1;
	var LR_UserInviteDiv=unescape("%3cdiv style%3d%22width%3a448px%3bheight%3a292px%3bbackground%3aurl(http%3a%2f%2ftj.fk100.com%2fchat%2ffloat.gif)%3b overflow%3ahidden%3b position%3arelative%22%3e%3cdiv style%3d%22z-index%3a 2%3b top%3a 0px%3b right%3a 1px%3b position%3a absolute%3b width%3a 30px%3b height%3a 30px%3b%22%3e%3ca href%3d%22javascript%3avoid(0)%22 onclick%3d%22%7b1%7dreturn false%3b%22 style%3d%22display%3ablock%3bwidth%3a 30px%3b height%3a 30px%3b text-indent%3a-999em%3b%22%3e%3c%2fa%3e%3c%2fdiv%3e%3cdiv style%3d%22z-index%3a 1%3b position%3a absolute%3b width%3a 448px%3b height%3a 292px%3b left%3a 0px%3b top%3a -1px%3b%22%3e%3ca href%3d%22javascript%3avoid(0)%22 onclick%3d%22%7b0%7dreturn false%3b%22 style%3d%22display%3ablock%3btext-indent%3a-999em%3bwidth%3a 448px%3b height%3a 292px%3b %22%3e%3c%2fa%3e%3c%2fdiv%3e%3c%2fdiv%3e");
	...
	var LR_pm001=1;
	setInterval("if(typeof(LR_nextshowmini_s)!='undefined')LR_nextshowmini_s='lr';",20);
	...
	var LR_pm004=1;
	var LR_pm006='#4a86e8';
	if(typeof(LR_showminiDivtimeout)=='undefined')var LR_showminiDivtimeout=4;
	var LR_pm007=1;
	var LR_pm011=0;
	var LR_pm012=30;
...
var data='id='+LR_siteid+'&sid='+LR_sid+'&cid='+LR_cid+'&lng='+LR_lng;
	data+='&p='+escape(location.href)+'&r='+lr_refer5237+'&e='+escape(LR_explain)+'&NBDA='+LR_ONAN;
...
checkcount=-1;LR_inviteimgJS=0;LR_hcloopJS(LR_sysurl+'js/JS_Float.aspx',data);LR_explain='';
		...
		var minichathtml1=(typeof(minichathtml)!='function');if(minichathtml1)document.write('<link href="http://dkt.zoosnet.net/js/JS5.css" rel="stylesheet" type="text/css" />');
...
function lrminiMin0(nop) {
	if (!lr_mini_blanksrc && nop) {
		window.onunload = lr_winunload;
		LR_miniframe.location = LR_sysurl + 'JS/im2.aspx';
		clickopenmini = 0;
		lr_mini_blanksrc = 1;
	}
}
...
function LR_IPCB(_lrip) {
    if(_lrip.status==0)
    {
        LR_hcloopJS(LR_sysurl + 'LS/newsidip.aspx', 'id=' + LR_siteid + '&sid=' + LR_sid + '&lng='+_lrip.result.location.lng+'&lat='+_lrip.result.location.lat+'&nation='+_lrip.result.ad_info.nation+'&province='+_lrip.result.ad_info.province+'&city='+_lrip.result.ad_info.city);
    }
}
function LR_LS() {
	if (LR_sidexists == -1) {
