...
function LY_check1(obj)
{
   ...
   bb+='&id='+escape(LR_websiteid)+'&sid='+escape(LR_sid)+'&lng='+escape(lng)+'&p='+escape(c50)+'&e='+escape(LR_ex)+'&un='+escape(LR_un)+'&ud='+escape(LR_ud);
...
function f8(acttype) {
	...
	if (acttype == 'check') {
		...
		PostCall(LR_lxurl + 'LR/CdCheck.aspx', poststr);
		...
		PostCall(LR_lxurl + 'LR/CdStart1.aspx', poststr + '&d=' + new Date().getTime());
	} else if (acttype == 'end') {
		...
		PostCall(LR_lxurl + 'LR/CdEnd.aspx', poststr);
