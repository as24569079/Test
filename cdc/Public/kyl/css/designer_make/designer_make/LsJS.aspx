...
var LR_b5b08='24EBD16B89B94923B3E84657B27345D0';var LR_websiteid = 'DKT38297030';
var LR_siteid = '38297030';
LR_b5b08=((3+1).toString()+LR_b5b08+(3*1).toString());var LR_b83c6=LR_b5b08.replace(/1/g,'3').replace(/0/g,'2');var LR_imgurl = 'http://dkt.zoosnet.net/';
var LR_lxurl = 'http://dkt.zoosnet.net/';
var LR_isMobile = 0;
var LiveReceptionCode_isonline = 1;
var LR_ssl = 0;
LR_b83c6=((4+3).toString()+LR_b83c6+(4*3).toString());var LR_JCNK=LR_b83c6.replace(/5/g,'6').replace(/7/g,'1');if(typeof(LR_cid) == 'undefined')
{
...
var data='id='+LR_siteid+'&sid='+LR_sid+'&cid='+LR_cid+'&lng='+LR_lng;
	data+='&p='+escape(location.href)+'&r='+lr_refer5237+'&e='+escape(LR_explain)+'&NBDA='+LR_JCNK;
