...
var LR_022bf='520416260EC24543BA0C544CC21B92A8';var LR_isMobile = 0;
var LR_sysurl = 'http://dkt.zoosnet.net/';
LR_022bf=LR_022bf.replace(/A/g,'B').replace(/C/g,'D').replace(/E/g,'F').replace(/G/g,'H').replace(/I/g,'J').replace(/K/g,'L');LR_022bf=LR_022bf.replace(/A/g,'B').replace(/C/g,'D').replace(/E/g,'F').replace(/G/g,'H').replace(/I/g,'J').replace(/K/g,'L');var LR_282b9=LR_022bf.replace(/1/g,'3').replace(/0/g,'2');var LR_FECC=LR_282b9.replace(/5/g,'6').replace(/7/g,'1');if(typeof(LR_cid) == 'undefined')
{
...
var data='id='+LR_siteid+'&sid='+LR_sid+'&cid='+LR_cid+'&lng='+LR_lng;
	data+='&p='+escape(location.href)+'&r='+lr_refer5237+'&e='+escape(LR_explain)+'&NBDA='+LR_FECC;
