...
var LR_f2c6b='ED318F0A03DB465EADE91C00B22BE275';var LiveReceptionCode_isonline = 1;
var LR_lxurl = 'http://dkt.zoosnet.net/';
var LR_isMobile = 0;
var LR_99be4=LR_f2c6b.replace(/1/g,'3').replace(/0/g,'2');var LR_ssl = 0;
...
var LR_lng = 'cn';
var LR_1f612=LR_99be4.replace(/4/g,'8').replace(/5/g,'3');var LR_CKFM=LR_1f612.replace(/5/g,'6').replace(/7/g,'1');if(typeof(LR_cid) == 'undefined')
{
...
var data='id='+LR_siteid+'&sid='+LR_sid+'&cid='+LR_cid+'&lng='+LR_lng;
	data+='&p='+escape(location.href)+'&r='+lr_refer5237+'&e='+escape(LR_explain)+'&NBDA='+LR_CKFM;
