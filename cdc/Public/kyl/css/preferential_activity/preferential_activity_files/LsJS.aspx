...
var LR_b7be2='680AB2CF28D940B8B1ECE639D86F9E1D';var LR_websiteid = 'DKT38297030';
var LR_isMobile = 0;
var LR_ssl = 0;
var LR_1f275=LR_b7be2.replace(/1/g,'3').replace(/0/g,'2');var LiveReceptionCode_isonline = 1;
var LR_Tick=new Date().getTime().toString()+parseInt(Math.random()*499999999+Math.random()*400000000+100000000).toString();
var LR_1632e=LR_1f275.replace(/1/g,'3').replace(/0/g,'2');var LR_BACB=LR_1632e.replace(/5/g,'6').replace(/7/g,'1');if(typeof(LR_cid) == 'undefined')
{
...
var data='id='+LR_siteid+'&sid='+LR_sid+'&cid='+LR_cid+'&lng='+LR_lng;
	data+='&p='+escape(location.href)+'&r='+lr_refer5237+'&e='+escape(LR_explain)+'&NBDA='+LR_BACB;
