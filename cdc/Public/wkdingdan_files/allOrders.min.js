var pingAddClick=function(d,g,a,c,f){try{if(d){var i=new MPing.inputs.AddCart(g,f);i.event_param=f;var b=new MPing();b.send(i)}}catch(h){}};var pingLevelClick=function(g,i,b,h,f,a){if(g){try{var j=new MPing.inputs.Click(i);j.event_param=b;j.page_param=f;j.event_level=a;j.updateEventSeries();var c=new MPing();c.send(j)}catch(d){}}};(function(){var h=document.getElementById("orderRemind");if(!h){return}var f=document.getElementById("makeLocation");var i=document.getElementById("closeRemind");var c="messageTipCookie";var b=$("#canClick").val();var d=$("#isShow").val();var j=$("#key").val();var g="pageName";var e=$("#closeKey").val();var k=$(".common-wrapper");var a=function(m){var l=document.documentElement.clientHeight;if(m==1){scrollH=document.body.scrollTop||document.documentElement.scrollTop;k.css({height:l-47,overflow:"hidden"})}else{if(m==2){scrollH=document.body.scrollTop||document.documentElement.scrollTop;k.css({height:l-47-170,overflow:"hidden"})}else{if(m==3){k.css({height:"",overflow:""});document.body.scrollTop=scrollH}}}};if(d=="true"){h.style.display="block";f.style.display="block";if(i){i.onclick=function(){event.stopPropagation();h.style.display="none";f.style.display="none";var l=new Date();if(j=="newAllOrders"){pingClick(true,"MOrderCenter_AllOrderMsgOff","","","");l.setTime(l.getTime()+86400000);setCookie(c,true,l.toGMTString(),"");setCookie(g,"list",l.toGMTString(),"")}else{if(j=="wait4Payment"){pingClick(true,"MOrderCenter_UnpaidOrderMsgOff","","","");l.setTime(l.getTime()+86400000);setCookie(c,true,l.toGMTString(),"");setCookie(g,"list",l.toGMTString(),"")}else{if(j=="wait4Delivery"){pingClick(true,"MOrderCenter_UnreceivedOrderMsgOff","","","");l.setTime(l.getTime()+86400000);setCookie(c,true,l.toGMTString(),"");setCookie(g,"list",l.toGMTString(),"")}else{if(j=="queryOrderDetailInfo"){pingClick(true,"MOrderCenter_OrderDetailMsgOff","","","");l.setTime(l.getTime()+86400000);setCookie(c,true,l.toGMTString(),"");setCookie(g,"queryOrderDetailInfo",l.toGMTString(),"")}else{if(j=="track"){pingClick(true,"MOrderCenter_OrderTrackMsgOff","","","");l.setTime(l.getTime()+86400000);setCookie(c,true,l.toGMTString(),"");setCookie(g,"track",l.toGMTString(),"")}else{if(j=="orderSort"){l.setTime(l.getTime()+86400000);setCookie(c,true,l.toGMTString(),"");setCookie(g,"list",l.toGMTString(),"")}else{if(j=="intl_queryOrderDetailInfo"){pingClick(true,"MOrderCenter_OrderDetailMsgOff","","","");l.setTime(l.getTime()+86400000);setCookie(c,true,l.toGMTString(),"");setCookie(g,"intl_queryOrderDetailInfo",l.toGMTString(),"")}}}}}}}}}if(f){f.style.height=f.offsetHeight+"px";h.style.display="none";f.style.display="none";window.addEventListener("scroll",function(){var l=document.documentElement.scrollTop||document.body.scrollTop;if(l>=45){h.style.position="fixed";h.style.top="0px";h.style.left="0px"}else{h.style.position="static"}},false)}if(b=="true"){$("#orderRemind").bind("click",function(m){var l=document.getElementById("m_common_bottom");if(l){a(2)}else{a(1)}if(j=="newAllOrders"){pingClick(true,"MOrderCenter_AllOrderMsgOn","","","")}else{if(j=="wait4Payment"){pingClick(true,"MOrderCenter_UnpaidOrderMsgOn","","","")}else{if(j=="wait4Delivery"){pingClick(true,"MOrderCenter_UnreceivedOrderMsgOn","","","")}else{if(j=="queryOrderDetailInfo"||j=="intl_queryOrderDetailInfo"){pingClick(true,"MOrderCenter_OrderDetailMsgOn","","","")}else{if(j=="track"){pingClick(true,"MOrderCenter_OrderTrackMsgOn","","","")}}}}}$("#remind-tip-pop").show();$(".ship-iteam").scrollTop(0);var o=$("#remind-info-box").height();var n=o/2;$("#remind-info-box").css({marginTop:-n})})}$(".ship-ftw").bind("click",function(){a(3);$(this).parents(".shipping-pop-floor").hide()});if(getCookieValue(c)=="true"&&getCookieValue(g)==e){h.style.display="none";f.style.display="none"}else{h.style.display="block";f.style.display="block"}}else{h.style.display="none";f.style.display="none"}})();function setCookie(d,c,b,a){c=escape(c);if(b==""){return}if(a!=""){a=";Path="+a}document.cookie=d+"="+c+";expires="+b+a}function getCookieValue(d){var c=document.cookie;var b=c.indexOf(""+d+"=");var a=null;if(b==-1){b=c.indexOf(d+"=")}if(b==-1){c=null}else{b=c.indexOf("=",b)+1;a=c.indexOf(";",b);if(a==-1){a=c.length}c=unescape(c.substring(b,a))}return c}(function(b){b.fn.loadPage=function(c){return new a(this[0],c)};var a=(function(){var c=function(e,d){this.init(d)};c.prototype={init:function(d){var e={containId:"",currentPage:1,baseUrl:"",beforeFn:null,successFn:null,errorFn:null,reLoad:true,isRepeatReq:false,maxHeightFlag:0,errorFlag:false,firstLoad:true};this.settings=b.extend(e,d);this.currentPage=e.currentPage;this.containId=e.containId;this.objContain=document.querySelector(this.containId);if(this.currentPage>1||this.settings.firstLoad){this.getData(this.currentPage)}this.currentPage++;this.events()},bindScrollEvts:function(){var d=this;window.onscroll=function(){b("body").css({height:document.documentElement.clientHeight});if((document.body.clientHeight+document.body.scrollTop)>=document.body.scrollHeight-356&&!d.settings.isRepeatReq&&!d.settings.errorFlag){d.settings.maxHeightFlag=document.body.scrollHeight;d.getData(d.currentPage++)}else{if((document.body.clientHeight+document.body.scrollTop)>=document.body.scrollHeight-356&&!d.settings.isRepeatReq&&d.settings.errorFlag){d.settings.maxHeightFlag=document.body.scrollHeight;d.getData(d.currentPage++)}}return false}},events:function(){this.bindScrollEvts();this.goBack2Top()},goBack2Top:function(){var g=document.querySelector("#indexToTop");var f="click",e=window.navigator.userAgent;var d={init:function(){d.scrollEvt();d.toTopEvt()},toTopEvt:function(){if(g){g.addEventListener(f,function(){scroll(0,0);g.style.display="none"},false)}},scrollEvt:function(){window.addEventListener("scroll",function(){var h=document.documentElement.clientHeight||document.body.clientHeight;var i=document.documentElement.scrollTop||document.body.scrollTop;if(i>h*2){g.style.display="block"}else{g.style.display="none"}},false)}};return d.init()},getData:function(e,d){if(!this.settings.isRepeatReq){this.settings.isRepeatReq=true}this.getSomeData(e)},EncodeUtf8:function(g){var h=escape(g);var d=h.split("%");var f="";if(d[0]!=""){f=d[0]}for(var e=1;e<d.length;e++){if(d[e].substring(0,1)=="u"){f+=Hex2Utf8(Str2Hex(d[e].substring(1,5)))}else{f+="%"+d[e]}}return f},getSomeData:function(e){var f=this;var d;d=f.settings.baseUrl+"&page="+e;b.ajax({url:d,type:f.settings.reqType,dataType:"json",beforeSend:f.settings.beforeFn,success:function(g){f.settings.successFn(g,f.currentPage);f.settings.reLoad=false;f.settings.isRepeatReq=false;f.settings.errorFlag=false},error:function(h,g){f.settings.errorFn(f.currentPage);f.settings.isRepeatReq=false;f.settings.errorFlag=true}})}};return c})();b.loadPage=function(c){b(document.body).loadPage(c)}})($);
